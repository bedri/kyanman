...
NETWORKS = (
    ...
    # DRK Kyan mainnet : drkv/drkp
    NetworkValues(
        "Kyan", "mainnet", "KYAN", b'\xcc', b'\x4c', b'\x10', h2b("02fe52f8"), h2b("02fe52cc")),

    # DRK Kyan testnet : DRKV/DRKP
    NetworkValues(
        "Kyan", "testnet", "tKYAN", b'\xef', b'\x8b', b'\x13', h2b("3a8061a0"), h2b("3a805837")),
