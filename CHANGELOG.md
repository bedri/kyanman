...
0.1.26 -  Sun Jan 21 08:45:23 2018 +0000
    ...
    bugfix - kyanvote - skip stale proposals

    style - kyanvote - text edits


0.1.25 -  Sun Mar 26 05:00:38 2017 +0000

    enh - add .kyancore to path in .bash_aliases on install
    enh - better block sync check
    enh - better kyand running detection
    enh - better sentinel sync messaging
    enh - kyanvote 12.1 compat - background delayed sends
...
0.1.20 -  Fri Sep 2 06:49:52 2016 +0000
    ...
    bugfix - kyanvote - prune completed proposals
    bugfix - follow redirects - kyanninja 301->www
...
0.1.16 -  Tue Dec 29 05:41:43 2015 +0000
    ...
    bugfix - support kyan.org downloads page shift to relative pathing

0.1.15 -  Thu Nov 26 02:57:45 2015 +0000

    update download url to kyan.org
    bugfix - support stale nss lib - downgrade second kyanninja attempt
    kyanvote - monkey-patch subprocess.check_output for python <2.7
...
0.1.14 -  Sun Nov 1 03:57:56 2015 +0000
    ...
    kyanvote - added git checkout info to version header
    kyanvote - added loading screen, previous vote detection, vim navigation binding
    kyanvote - added vote-counts, turnout percentage
    kyanvote - bugfix - use alias for vote display - added threshold coloring, sort vote display by block start
    kyanvote - align count/percentage columns
    kyanvote - display vote hash during voting
    kyanvote - ignore unmapped keystrokes
...
0.1.13 -  Sun Oct 25 05:49:37 2015 +0000
    ...
    bugfix - fail gracefully when kyanninja api offline
...
0.1.12 -  Tue Oct 20 21:14:51 2015 +0000
    ...
    bugfix - status - fail gracefully if kyand not running
...
0.1.11 -  Wed Oct 14 08:19:10 2015 +0000
    ...
    bugfix - voting - fail gracefully when kyan-cli not in path
...
0.1.10 -  Tue Oct 13 07:18:29 2015 +0000
    ...
    added kyand uptime calculation
    added support for hot-node (Internet server) kyan.conf voting
...
0.1.9 - Sun Oct 11 04:05:54 2015 +0000
    ...
    added kyanvote - time-randomized voting, initial curses UI
...
0.1.6 - Tue Sep 8 07:07:57 2015 +0000
    ...
    added kyanninja masternode visibility

0.1.5 - Thu Sep 10 21:34:29 2015 +0000

    added kyanwhale, masternode.me polling
...
0.1.0 - Mon Sep 7 00:12:24 2015 +0000
    ...
    created new top-level script 'kyanman'

    takes command line arguments:

        install
            - install latest kyan executables (fresh install)
        reinstall
            - reinstall latest kyan executables (overwrite existing)
        update
            - update to latest kyan executables (update existing)
        sync
            - sync with github (git fetch/reset)
        restart
            - restarts (or starts) kyand
...
0.0.8 - Thu Aug 27 07:57:15 2015 +0000
    ...
    added command line switches
        ...
        -h, --help
        -v, --version
    sync_kyanman_to_github.sh now pulls and sync's forced tags
